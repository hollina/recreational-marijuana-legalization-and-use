...
twoway ///
	|| scatter   x order if x!=0 & order<72 & shape==1 & shade == 3, msymbol(O) mcolor(vermillion) msize(2.5) ///
	|| rcap   low high order if x!=0 & order<72 & shape==1 & shade == 3,  lcolor(vermillion)  msize(1.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==2 & shade == 3, msymbol(S) mcolor(sea) msize(2.5) ///
	|| rcap   low high order if x!=0 & order<72 & shape==2 & shade == 3,  lcolor(sea) msize(1.5)  ///
	|| scatter   x order if x!=0 & order<72 & shape==3 & shade == 3, msymbol(D) mcolor(turquoise) msize(2.5) ///
	|| rcap   low high order if x!=0 & order<72 & shape==3 & shade == 3,  lcolor(turquoise) msize(1.5)  ///	
	|| rcap   low high order if x!=0 & order<72 & shape==2 & shade == 2,  lcolor(sea) msize(1.5)  ///
	|| rcap   low high order if x!=0 & order<72 & shape==3 & shade == 2,  lcolor(turquoise) msize(1.5)  ///
	|| rcap   low high order if x!=0 & order<72 & shape==1 & shade == 2,  lcolor(vermillion)  msize(1.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==1 & shade == 2, msymbol(O) mcolor(white) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==1 & shade == 2, msymbol(O) mcolor(vermillion%50) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==2 & shade == 2, msymbol(S) mcolor(white) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==2 & shade == 2, msymbol(S) mcolor(sea%50) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==3 & shade == 2, msymbol(D) mcolor(white) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==3 & shade == 2, msymbol(D) mcolor(turquoise%50) msize(2.5) ///		
	|| rcap   low high order if x!=0 & order<72 & shape==2 & shade == 1,  lcolor(sea) msize(1.5)  ///
	|| rcap   low high order if x!=0 & order<72 & shape==3 & shade == 1,  lcolor(turquoise) msize(1.5)  ///
	|| rcap   low high order if x!=0 & order<72 & shape==1 & shade == 1,  lcolor(vermillion)  msize(1.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==1 & shade == 1, msymbol(O) mcolor(vermillion) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==1 & shade == 1, msymbol(O) mcolor(white) msize(1.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==2 & shade == 1, msymbol(S) mcolor(sea) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==2 & shade == 1, msymbol(S) mcolor(white) msize(1.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==3 & shade == 1, msymbol(D) mcolor(turquoise) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==3 & shade == 1, msymbol(D) mcolor(white) msize(1.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==1 & shade == 0, msymbol(Oh) mcolor(vermillion) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==1 & shade == 0, msymbol(Sh) mcolor(sea) msize(2.5) ///
	|| scatter   x order if x!=0 & order<72 & shape==1 & shade == 0, msymbol(Dh) mcolor(turquoise) msize(2.5) ///
...
graph export "output/plots/main_recreational_figure_for_paper_robust_part_a.pdf", replace	
graph export "output/plots/main_recreational_figure_for_paper_robust_part_a.png", replace	
